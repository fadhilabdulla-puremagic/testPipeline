...
const previewList = [
  {
    ...
    videoUrl: "https://vimeo.com/891601142",
    description: "lorem ipsum sdadks dsmds dsd sdjsds dsj sjdns",
  },
  {
    title: "Basics of colours psychology",
    videoUrl: "https://vimeo.com/891601142",
    description: "lorem ipsum sdadks dsmds dsd sdjsds dsj sjdns",
  },
];
                      ...
                      <div className="tab-content">
                        ...
                        >
                          <CoursePreviewComponent
                            sections={course_module_preview ?? []}
                          />
                              ...
                              course?.sections.map((module) => {
                                return (
                                  <>
                                    ...
                                    <div className="description-wrapper react-html">
                                      {module.description &&
                                      ...
                                      <div className="single-team">
                                        ...
                                        <div className="team-content">
                                          ...
                                          <span className="designation">
                                            {object.instructor_name}, Instructor
                                          </span>
                                        </div>
                                      </div>
                                      {/* Single Team End */}
                        ...
                        {status === "coming soon" ? (
                          ...
                          <span className="price">
                            ...
                            price === null ? (
                              ...
                              <span className="sale-price">AED {price}</span>
                            )}
                          </span>
                        )}
                      </div>
                      ...
                      <ul>
                        ...
                        {no_lectures && no_lectures > 0 ? (
                          <li>
                            ...
                            <strong>Lectures</strong> <span>{no_lectures}</span>
                          </li>
                        ) : (
                          <></>
                        )}
                        <li>
                          <i className="icofont-bars" /> <strong>Level</strong>{" "}
                    ...
                    {course_type && course_type?.toLowerCase() === "webinar" ? (
                      <div className="info-btn">
                        <button
                          ...
                          href="https://classes.upgrade-skills.com/login/"
